...
RUN rm -rf /var/cache/apk/* && \
    ...
    wget "https://github.com/ionic-team/ionicons/raw/master/fonts/ionicons.ttf" -P /usr/share/fonts/ko/TrueType/ && \ 
    wget "https://github.com/FortAwesome/Font-Awesome/raw/master/web-fonts-with-css/webfonts/fa-regular-400.ttf" -P /usr/share/fonts/ko/TrueType/ && \ 
    wget "https://github.com/FortAwesome/Font-Awesome/raw/master/web-fonts-with-css/webfonts/fa-brands-400.ttf" -P /usr/share/fonts/ko/TrueType/ && \ 
    wget "https://github.com/FortAwesome/Font-Awesome/raw/master/web-fonts-with-css/webfonts/fa-solid-900.ttf" -P /usr/share/fonts/ko/TrueType/ && \ 
    rm -rf /var/cache/apk/* && \
    rm -rf /tmp/*

#Download Birt Runtime
RUN wget "http://www.eclipse.org/downloads/download.php?file=/birt/downloads/drops/R-R1-4.7.0-201706222054/birt-runtime-4.7.0-20170622.zip&mirror_id=1" -O /tmp/birt-runtime.zip && \
